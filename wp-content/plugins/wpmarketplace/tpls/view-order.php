...
<thead>
<tr><th align="left"><?php echo __("Item Name","wpmarketplace");?></th><th align="left"><?php echo __("Unit Price","wpmarketplace");?></th><th align="left"><?php echo __("Quantity","wpmarketplace");?></th><th align="left"><?php echo __("Discount","wpmarketplace");?></th><th align="left"><?php echo __("Subtotal","wpmarketplace");?></th></tr>
</thead>
<?php 
...
foreach($oitems as $oitem){          
    ...
    $discount=($discount_r/100)*($oitem->price+$prices);
     ...
     echo "<tr><td>{$ditem->post_title}<br> {$variations}</td>
               ...
               <td>{$discount_r}%</td>
               <td>".$currency_sign.number_format(((($oitem->price+$prices)*$oitem->quantity)-$discount),2);"</td>
         </tr>";

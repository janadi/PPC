...
<button id="order_back" class="button btn" type="button"><span><span><?php echo __("Back","wpmarketplace");?></span></span></button> <button id="order_btn" class="button btn btn-success" type="submit"><span><span><?php echo __("Place Order","wpmarketplace");?></span></span></button>

    ...
    jQuery(function() { 
        ...
        jQuery( "#paccordion1" ).accordion({
            ...
            jQuery('#add_currency').live("click",function(){
               ...
               jQuery('#currency_table').append('<tr id="currency_row_'+tm+'"><td><input type="radio" name="currency_radio" class="currency_radio" id="'+tm+'"></td><td><input type="text" name="_wpmp_settings[currency]['+tm+'][currency_name]" value="'+jQuery('#currency_n').val()+'" class="currency_name"><input type="hidden" name="_wpmp_settings[currency]['+tm+'][currency_name]" value="'+jQuery('#currency_n').val()+'"></td><td><input  class="currency_symbol" type="text" name="_wpmp_settings[currency]['+tm+'][currency_symbol]" value="'+jQuery('#currency_s').val()+'"><input type="hidden" name="_wpmp_settings[currency]['+tm+'][currency_symbol]" value="'+jQuery('#currency_s').val()+'"></td><td><a href="#" class="del_currency" id="'+tm+'">Delete</a></td></tr>'); 

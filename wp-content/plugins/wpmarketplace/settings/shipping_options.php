...
<table class="form-table">
                    ...
                    <input type="checkbox" value="1" <?php if($settings['calc_shipping']==1)echo "checked='checked'";?> id="calc_shipping" name="_wpmp_settings[calc_shipping]">
...
<label for="flat_rate_enabled"><input type="checkbox" <?php if($settings['flat_rate_enabled']==1)echo "checked='checked'";?> class=""  value="1" id="flat_rate_enabled" name="_wpmp_settings[flat_rate_enabled]" style=""> <?php echo __("Enable this shipping method","wpmarketplace");?></label><br>
</fieldset></td>
</tr>
<tr valign="top">
...
<td class="forminp">
<fieldset><legend class="screen-reader-text"><span><?php echo __("Enable/Disable","wpmarketplace");?></span></legend>
<label for="free_shipping_enabled"><input type="checkbox" class="" <?php if($settings['free_shipping_enabled']==1)echo "checked='checked'";?>  value="1" id="free_shipping_enabled" name="_wpmp_settings[free_shipping_enabled]" style=""> <?php echo __("Enable Free Shipping","wpmarketplace");?></label><br>
</fieldset></td>
</tr>
<tr valign="top">
<th class="titledesc" scope="row"><?php echo __("Title","wpmarketplace");?></th>
...
<label for="local-delivery_enabled"><input type="checkbox" class="" <?php if($settings['local-delivery_enabled']==1)echo "checked='checked'";?>  value="1" id="local-delivery_enabled" name="_wpmp_settings[local-delivery_enabled]" style=""><?php echo __(" Enable local delivery","wpmarketplace");?></label><br>
</fieldset></td>
</tr>
<tr valign="top">
<th class="titledesc" scope="row"><?php echo __("Title","wpmarketplace");?></th>

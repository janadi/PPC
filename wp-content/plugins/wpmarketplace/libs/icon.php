...
foreach($fileinfo as $index=>$value):
    ...
    if(in_array($ext,$img)): ?>
        ...
        <input rel="wdmiconfile" style="display:none" <?php if($icon==$value['file']) echo ' checked="checked" ' ?> type="radio"  name="wpmp_list[icon]"  class="checkbox"  value="<?php echo $value['file'] ?>">

...
<tr><td><?php echo date("Y-m-d H:i",$sale->date); ?></td><td><?php echo $sale->post_title; ?></td><td><?php echo $sale->quantity; ?></td><td><?php echo wpmp_currency_sign().number_format($sale->price,2); ?></td><td><?php echo wpmp_currency_sign().number_format($sale->site_commission,2); ?></td><td><?php echo wpmp_currency_sign().number_format($sale->price-$sale->site_commission,2); ?></td></tr>
<?php } ?>

</tbody>
 <tfoot>
    <tr><th colspan="3"> </th><th><?php echo wpmp_currency_sign().number_format($total_sales,2); ?></th><th><?php echo wpmp_currency_sign().number_format($total_commission,2); ?></th><th><?php echo wpmp_currency_sign().number_format($total_earning,2); ?></th></tr>
    </tfoot>
</table>
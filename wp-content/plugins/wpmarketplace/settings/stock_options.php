...
<table class="form-table">
                    ...
                    <input type="checkbox" value="1" <?php if($settings['stock']['enable']==1)echo "checked='checked'";?> id="calc_shipping" name="_wpmp_settings[stock][enable]">
                    ...
                    <td class="forminp">                   
                    <input type="checkbox" class="global_low_stock" <?php if($settings['stock']['enable_low_stock']==1)echo 'checked="checked"';?> value="1"  name="_wpmp_settings[stock][enable_low_stock]">                   
                    </td>
                    ...
                    <td class="forminp">                   
                    <input type="checkbox"  value="1" <?php if($settings['stock']['low_stock_notification']==1)echo 'checked="checked"';?>  name="_wpmp_settings[stock][low_stock_notification]">                   
                    </td>
                    </tr> 
                    <tr valign="top" class="">
                    ...
                    <input type="checkbox"  value="1" <?php if($settings['stock']['reduce_auto']==1) echo "checked=checked";?>  name="_wpmp_settings[stock][reduce_auto]"> <?php echo __("Enable Stock Reduce Automatically","wpmarketplace");?>

...
<div class="checkout_div wp-marketplace">
    ...
    if(count($cart_items)==0) echo __("No item in cart.","wpmarketplace")."<br/><a href='".$settings['continue_shopping_url']."'>".__("Continue shopping","wpmarketplace")."</a>";
    else{
               ...
               'success':function(res){
                   //alert(res);
                    if(res.match(/success/)){
                       ...
                       jQuery('#rloading_first').slideUp();
                       jQuery('#rloading_message').html("Error occured in registering.");
                    }
               }
           });
        }
                ...
                jQuery(form).ajaxSubmit({
                   ...
                   'success':function(res){
                       ...
                       if(res.match(/success/)){
                           ...
                           jQuery('#loading_message').html("Username and password does not match.");
                        }
                   }
               });
            }

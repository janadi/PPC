...
<thead>
<tr>
<th width="85%"><?php echo __("Title","wpmarketplace");?></th>
...
<td>
<a href="<?php echo get_permalink().$sap; ?>section=wpmp-add-product&product=<?php echo $product->ID; ?>">Edit</a>
</td>
</tr> 
<?php    
}} else{
?>
<tr><td><?php echo __("You didn't add any product yet!","wpmarketplace");?></td><td></td></tr>
<?php    
}
?>
</tbody>

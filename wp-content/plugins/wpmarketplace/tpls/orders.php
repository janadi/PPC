...
<?php echo __("from","wpmarketplace");?> <input type="text" name="sdate" value="<?php echo $_REQUEST[sdate]; ?>"> 
<?php echo __("to","wpmarketplace");?> <input type="text" name="edate" value="<?php echo $_REQUEST[edate]; ?>">

<?php echo __("Order ID:","wpmarketplace");?> <input type="text" name="oid" value="<?php echo $_REQUEST[oid]; ?>">

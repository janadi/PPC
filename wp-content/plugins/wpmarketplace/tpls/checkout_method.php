...
<div style="clear: both;"></div>              
            ...
            <ul class="ul">
             ...
             <button id="register_btn" class="btn btn-success" type="submit"><span><span><?php echo __("Continue","wpmarketplace");?></span></span></button>
           </form>
            </div>
    <div class="span6">
...
<h1><?php echo __("Login","wpmarketplace");?></h1>
            ...
            <p class="login-submit"> 
                <button type="submit" name="wp-submit" id="wp-submit" class="btn btn-success" tabindex="100" ><?php echo __("Log In","wpmarketplace");?></button> 

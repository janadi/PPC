...
<table class="form-table">
                    ...
                    <input type="checkbox" value="1" <?php if($settings['tax']['enable']==1)echo "checked='checked'";?> id="calc_shipping" name="_wpmp_settings[tax][enable]">
                    ...
                    <td class="forminp">                   
                    <input type="checkbox" class="global_low_tax" <?php if($settings['tax']['tax_on_cart']==1)echo 'checked="checked"';?> value="1"  name="_wpmp_settings[tax][tax_on_cart]">                   

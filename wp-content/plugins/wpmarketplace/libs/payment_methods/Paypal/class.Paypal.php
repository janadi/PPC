...
class Paypal extends CommonVers{
    ...
    function Paypal($TestMode = 0){
        ...
        $this->Enabled= $settings['Paypal']['enabled'];
...
';
    ...
    function ShowPaymentForm($AutoSubmit = 0){
        ...
        if($AutoSubmit==1)
        $Form .= "<center>Processing....</center><script language=javascript>setTimeout('document._wpdm_bnf_{$this->InvoiceNo}.submit()',2000);</script>";
